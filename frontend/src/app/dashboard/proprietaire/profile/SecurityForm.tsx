      ...
      <form onSubmit={handlePasswordChange} className="space-y-4">
        ...
        <FormField label={t("auth.new_password")}>
          <DashInput
            ...
            placeholder={t("auth.new_password_hint")}
            suffix={
        ...
        <button
          type="submit"
          disabled={pwSaving}
          className="flex items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-bold text-white transition-all hover:opacity-90 disabled:opacity-60"
